...
We could not replicate the authors' approach as neatly as other parts of the paper due to hardware constraints which led us to working with a significantly smaller corpus. This left us with similar, but definitely less pronounced, results. <!-- eventuell einfügen, dass es variance beim Training gibt--> Despite limited resources we were able to reproduce the effect that manually changing the word frequency statistics for a single word significantly influences the resulting gender direction of the embedding space. This supports the conclusion of @wang_2020 that enhanced emphasis needs to be put on word frequency in debiasing techniques.
