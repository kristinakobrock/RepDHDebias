...
Again, we want to stress that there is sufficient ground to believe that the projection mitigates frequency <!-- MK: "among other"vielleicht?--> features. <!--MK: einfach im Sinne dass man nicht nur sagen kann dass nur frequency entfernt wird und nicht potentiell noch was anderes (wie idk POS tag oder so, will nur kein genaues Beispiel nennen, weil das wieder nix ist was ich auf Quellen beziehen kann) <!--, but just as other features will be mitigated. --><!--KK: Den Satz hiervor versteh ich nicht. Die zwei Sätze hiernach könnten wir finde ich auch weglassen (da der claim vorher schon genügend gemacht und begründet wurde)--><!--MK: löschen: Which exactly those are will vary from embedding set to embedding set. Ultimately, claiming that Double-Hard Debias works because it removes frequency as such seems to be a simplification of the algorithm. -->
