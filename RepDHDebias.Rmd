...
For Concept Categorization set of words are provided, each being assigned to one of $k$ classes. After spacial clustering of the embedding space, it is evaluated how many of the words of a class could correctly be assigned to the same cluster. Higher accuracies suggests that the words with a high semantic relation, referencing the same concept, also are represented by spatially close embeddings, as it would be desirable in an embedding space.
<!-- MK: hab hier nochmal unformuliert, bitte noch mal cross-checken!-->
